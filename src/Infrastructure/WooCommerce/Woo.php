...
class Woo {
        ...
        public function handle_manual_dte( $order ): void {
                ...
                $folioManager = $this->container->get( 'folio_manager' );
                $reservedFolio = $folioManager->reserve_folio_temporarily( $type );
                ...
                try {
                        ...
                        $folioManager->mark_folio_used( $type, $reservedFolio );
                } catch ( \Exception $e ) {
                        $folioManager->release_reserved_folio( $type );
                        throw $e;
                }
        }
