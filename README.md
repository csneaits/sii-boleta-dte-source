...
- **Cola persistente**: envíos al SII (DTE y recibos) se guardan en `sii_boleta_dte_queue` y se procesan de forma segura por cron o manualmente, con reintentos y bitácora centralizada.
...
- `src/Application/` implementa casos de uso (folios y cola de envíos).
