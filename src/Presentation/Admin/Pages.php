...
if ( in_array( $hook, array( 'toplevel_page_sii-boleta-dte', 'sii-boleta-dte_page_sii-boleta-dte' ), true ) ) {
        ...
        \wp_localize_script(
                ...
                'queueNonce'      => function_exists( 'wp_create_nonce' ) ? \wp_create_nonce( 'sii_boleta_queue' ) : '',
                    'texts'           => array(
                    ...
                    'queueConfirmTitle' => __( 'Confirmar acción', 'sii-boleta-dte' ),
                    'queueConfirmProcess' => __( 'Se procesará el documento seleccionado de inmediato. ¿Deseas continuar?', 'sii-boleta-dte' ),
                    'queueConfirmRequeue' => __( 'Se reiniciarán los intentos de este trabajo. ¿Deseas continuar?', 'sii-boleta-dte' ),
                    'queueConfirmCancel' => __( 'Se cancelará y eliminará el trabajo de la cola. ¿Deseas continuar?', 'sii-boleta-dte' ),
                    'queueConfirmProceed' => __( 'Continuar', 'sii-boleta-dte' ),
                    'queueConfirmAbort' => __( 'Cancelar', 'sii-boleta-dte' ),
                    'queueConfirmGeneric' => __( 'Esta acción se ejecutará inmediatamente. ¿Deseas continuar?', 'sii-boleta-dte' ),
                ),
            )
        );
}
