...
class SettingsPage {
	...
	public function register(): void {
		...
		add_settings_field( 'acteco', __( 'Código Acteco', 'sii-boleta-dte' ), array( $this, 'field_acteco' ), 'sii-boleta-dte', 'sii_boleta_emitter' );
                ...
                // Automation.
                add_settings_section( 'sii_boleta_automation', __( 'Automatización', 'sii-boleta-dte' ), '__return_false', 'sii-boleta-dte' );
                add_settings_field( 'rvd_auto', __( 'RVD diario', 'sii-boleta-dte' ), array( $this, 'field_rvd_auto' ), 'sii-boleta-dte', 'sii_boleta_automation' );
                add_settings_field( 'libro_auto', __( 'Libro mensual', 'sii-boleta-dte' ), array( $this, 'field_libro_auto' ), 'sii-boleta-dte', 'sii_boleta_automation' );
        ...
        if ( ! function_exists( 'settings_fields' ) ) {
            return;
                ...
                $steps = array(
                        ...
                        'automation'   => array(
                                'label'       => __( 'Automatización', 'sii-boleta-dte' ),
                                'title'       => __( 'Automatización y correo', 'sii-boleta-dte' ),
                                'description' => __( 'Programa RVD y Libro automáticos y enlaza perfiles SMTP para correos transaccionales.', 'sii-boleta-dte' ),
