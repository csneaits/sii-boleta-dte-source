...
<th><?php echo esc_html__( 'Disponibles', 'sii-boleta-dte' ); ?></th>
	...
	/** Shows latest log entries. */
        private function render_recent_logs(): void {
                ...
                $rows       = $logs_data['rows'];
                // Ocultar filas técnicas tipo "Enviado (pendiente)" sin track id/folio
                // generadas por logs informativos. Mantenerlas en la base para
                // diagnóstico, pero no mostrarlas en la grilla de DTE.
                $rows = array_values( array_filter( (array) $rows, static function( $row ) {
                        ...
                        // Include rows with 'Enviado (pendiente)' status and ensure consistent rendering
                        return $status !== 'enviado (pendiente)' || $tid !== '' || $folio > 0;
                }));
                                                ...
                                                <tr>
                                                        <td>
                                                                <span class="sii-track-id-clickable" 
                                                                        ...
                                                                        <?php echo esc_html( $track_id_value ?: 'Sin TrackID' ); ?>
                                                                </span>
                                                        </td>
